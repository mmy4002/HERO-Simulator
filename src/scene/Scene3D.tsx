...
/** Optional secondary view: the procedural interactive 3D scene. */
export default function Scene3D({ frame, showLabels = true }: HelmetSceneProps) {
  ...
  return (
    <div
      data-view="3d"
      style={{ position: 'absolute', inset: 0, overflow: 'hidden', background: 'linear-gradient(180deg, #f4f6f7 0%, #e3e8eb 100%)' }}
    >
